...
@NgModule({
  declarations: [DashboardComponent, CategoryComponent, CategoryAddComponent, CategoryListComponent, AdminProductComponent, ProductAddComponent, ProductListComponent, AdminOrderComponent, AdminOrderListComponent, OrderUpdateComponent],
  imports: [
    CommonModule,
    AdminRoutingModule,
